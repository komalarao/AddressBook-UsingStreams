package com.bridgelabz.addressBookUsingStreams;
...
public class AddressBook {
	...
	public void searchByCity() {
		...
		String city = sc.next();
		list.stream().filter(contacts -> contacts.getCity().equalsIgnoreCase(city))
	...
	public void searchByState() {
		...
		list.stream().filter(contacts -> contacts.getState().equalsIgnoreCase(state))
				.forEach(contacts -> System.out.println(contacts));
	}
}
